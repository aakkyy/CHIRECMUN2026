              ...
              <div className={styles.phaseBody}>
                ...
                <div className={styles.phaseContent}>
                  ...
                  <p className={styles.phaseDesc}>
                    Round 1 Delegate Applications are open now.
                  </p>

                  <a
                    href="https://forms.cloud.microsoft/pages/responsepage.aspx?id=gtzSBu1vO02SGDfTT7BAW4J3U5c18QpFrxiPyTk3MHlUMTI3Qk8yWVlXSDM1UElJUjZPUE44SlcxRS4u&route=shorturl"
                    target="_blank"
            ...
            <div className={styles.phaseCard}>
              ...
              <div className={styles.phaseBody}>
                ...
                <div className={styles.phaseContent}>
                  ...
                  <p className={styles.phaseDesc}>
                    International Press applications are open now.
                  </p>

                  <a
                    href="https://forms.cloud.microsoft/pages/responsepage.aspx?id=gtzSBu1vO02SGDfTT7BAW7lVwOEa8VdJix4pjIgOkt5UQUxUTzBHQ04xVkRWWEpHMVI5TUFKWFRDQy4u&route=shorturl"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`${styles.phaseBtn} ${styles.phaseBtnActive}`}
                  >
