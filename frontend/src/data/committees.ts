...
export const COMMITTEES: Committee[] = [
  ...
  { id: 'jcc-1',    abbr: 'JCC-1',  name: 'Joint Crisis Cabinet I',                           category: 'Crisis Committee',      type: 'crisis' },
  { id: 'jcc-2',    abbr: 'JCC-2',  name: 'Joint Crisis Cabinet II',                          category: 'Crisis Committee',      type: 'crisis' },
